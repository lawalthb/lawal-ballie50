...
<div class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('tenant.payroll.employees.create', $tenant) }}"
                    ...
                    <a href="{{ route('tenant.payroll.employees.export', $tenant) }}"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
            <form method="GET" action="{{ route('tenant.payroll.employees', $tenant) }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('tenant.payroll.employees', $tenant) }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg font-medium transition-colors duration-300">
                        Clear
                    </a>
                </div>
            </form>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-gray-600">ID: {{ $employee->employee_number ?? 'N/A' }}</span>
                            </div>
                            <div class="flex items-center text-sm">
                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <span class="text-gray-600">Joined {{ $employee->hire_date ? $employee->hire_date->format('M Y') : 'N/A' }}</span>
                            </div>
                            <div class="flex items-center text-sm">
                                <i class="fas fa-money-bill-wave text-gray-400 w-4 mr-2"></i>
                                <span class="text-gray-600">₦{{ number_format($employee->currentSalary->base_salary ?? 0, 2) }}/month</span>
                            </div>
                        </div>

                        <div class="flex space-x-2">
                            <a href="{{ route('tenant.payroll.employees.show', [$tenant, $employee]) }}"
                            ...
                            <a href="{{ route('tenant.payroll.employees.edit', [$tenant, $employee]) }}"
                            ...
                            <a href="{{ route('tenant.payroll.employees.payslip', [$tenant, $employee]) }}"
