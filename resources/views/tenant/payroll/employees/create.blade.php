...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="{{ route('tenant.payroll.employees.store', $tenant) }}" method="POST" class="space-y-8">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="employee_number" value="{{ old('employee_number') }}"
                               ...
                               class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent @error('employee_number') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="job_title" value="{{ old('job_title') }}" required
                               class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent @error('job_title') border-red-500 @enderror">
                        @error('job_title')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="basic_salary" value="{{ old('basic_salary') }}" required min="0" step="0.01"
                                   class="w-full border border-gray-300 rounded-lg pl-8 pr-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent @error('basic_salary') border-red-500 @enderror">
                        </div>
                        @error('basic_salary')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="pay_frequency" required class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent @error('pay_frequency') border-red-500 @enderror">
                            ...
                            <option value="contract" {{ old('pay_frequency') === 'contract' ? 'selected' : '' }}>Contract</option>
                        </select>
                        @error('pay_frequency')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="account_name" value="{{ old('account_name') }}"
                               class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-emerald-500 focus:border-transparent @error('account_name') border-red-500 @enderror">
                        @error('account_name')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
